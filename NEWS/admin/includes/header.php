         ...
         <div id="topbar" class="clearfix">
             <div class="wrap-inner">
                <ul id="top-menu" class=" fl-right">
                    <li class="fl-left"><a href="./quanlibaiviet.php">News Management</a></li>
                    <li class="fl-left"><a href="./thembaiviet.php">Add News</a></li>
                    <li class="fl-left"><a href="./quanlithanhvien.php" onClick="return checkPermision()">Members Management</a></li>
