...
function tach_chu_hien_thi($content){
      //lay 15 chu dau tien ra de hien thi
...
function tach_chu_hien_thi_noibat($content){
    //lay 45 chu dau tien ra de hien thi
    $mang = explode(" ", $content);
    $str = "";
    for($j = 0; ($j < 45) && ($j<count($mang)); $j++){
        $str = $str." ".$mang[$j];
    }
    return $str;
}
...
<?php
    //lấy 1 bài mới nhất cho vào tin nổi bật của trang
...
?>
         ...
         <div id="featured" class="wrap-inner clearfix">
              <div class="main-featured fl-left">
                  <img src="<?php echo $tin_noi_bat["url_hinhanh"]; ?>" style="width: 450px; height:270px;" alt="">
                  <br>
